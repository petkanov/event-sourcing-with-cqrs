package com.techbank.account.cmd.peter.service;

import com.techbank.account.cmd.peter.model.command.OpenAccountCommand;
...
public class AccountAggregate extends AggregateRoot {
    ...
    public AccountAggregate(OpenAccountCommand command) {
        final String newAggregateId = UUID.randomUUID().toString();
